...
# Assignment: 6
# Due Date: 14Mar24
# Description: Designed a Hash Map method with Chaining for Collision Resolutions
...
class HashMap:
    ...
    def put(self, key: str, value: object) -> None:
        ...
        # Sets node equal to the node that contains that key value
    ...
    def resize_table(self, new_capacity: int) -> None:
        ...
        # Add key/value pairs into updated HashMap
        for i in range(prev_arr.length()):
            for node in prev_arr[i]:
    ...
    def empty_buckets(self) -> int:
        """
        This method returns the number of empty buckets
        """
        empty_count = 0
    ...
    def contains_key(self, key: str) -> bool:
        """
        This method returns True if the Key is in the HashMap and False if not
        """
        index = self._hash_function(key) % self._capacity
    ...
    def remove(self, key: str) -> None:
        """
        This method removes a value from the HashMap
        """
...
def find_mode(da: DynamicArray) -> tuple[DynamicArray, int]:
    """
    This function returns a tuple that contains a DynamicArray containing the mode and an integer that represents the
    frequency
    """
    ...
    for i in range(new_arr.length()):
        if freq < new_arr.get_at_index(i)[1]:
            freq = new_arr.get_at_index(i)[1]

    for i in range(new_arr.length()):
        if new_arr.get_at_index(i)[1] == freq:
            arr_mode.append(new_arr.get_at_index(i)[0])

    return arr_mode, freq
